...
class Image:
    ...
    def __init__(  # noqa: PLR0912, PLR0913, PLR0915 -- this function does a _lot_
        ...
        print(f"output: {self.output_filename} <= {self.type}")
    ...
    def process(  # noqa: PLR0912, PLR0915 -- this function does a lot
        ...
        self.output_filename = self.output_filename.replace("jpg", "png")
        image.save(
...
def initialized(pelican: Pelican):  # noqa: PLR0915
    ...
    if pelican:
        ...
        pelican.settings.setdefault(
            "PHOTO_DEFAULT_IMAGE_OPTIONS", {"jpeg": {"optimize": True}, "png": {"optimize": True} }
        )
