...
def insert_read_more_link(instance):
    ...
    summary = truncate_html_words(instance.content, SUMMARY_MAX_LENGTH, SUMMARY_END_SUFFIX)
    ...
    if summary != instance.content:
        ...
        if result:
            ...
            logger.debug(f"[read_more] Summary (after inject): {instance.metadata['summary']}")
        else:
