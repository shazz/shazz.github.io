...
image: {filename}../../../gallery/vaccines/duplicator.png
Tags: Vaccine


## Basic Information

- *Author*: Flix from Offbeat (then Delta Force)
- *Type*: bootsector
...
<img src="{attach}duplicator_photo_0.png" width="45%"/>&nbsp;<img src="{attach}duplicator_photo_1.png" width="45%"/>
...
You can download Duplicator copier from [demozoo](https://demozoo.org/productions/90356/)